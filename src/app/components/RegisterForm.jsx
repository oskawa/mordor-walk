      ...
      switch (name) {
        case "username":
          if (!value.trim()) {
            ...
            newErrors.username =
              "Le pseudo doit contenir 3-20 caractères (lettres, chiffres, - et _ uniquement)";
          } else {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        `${NEXT_PUBLIC_WORDPRESS_REST_GLOBAL_ENDPOINT}/auth/v1/register`,
        {
  ...
  return (
    <>
      ...
      <div className={styles.registerButton}>
        <button onClick={() => setActiveMenu("login")} disabled={isSubmitting}>
