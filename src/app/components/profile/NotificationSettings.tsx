  ...
  const handleEnableNotifications = async () => {
    ...
    try {
      ...
      if (error.message.includes("iOS non compatible")) {
        ...
        setMessage(
          "❌ Permission de notifications refusée. Vérifiez les paramètres de votre navigateur."
        );
      } else if (error.message.includes("Service Worker")) {
        setMessage(
          "❌ Service Worker non disponible. Vérifiez que vous êtes sur HTTPS."
        );
      } else if (error.message.includes("Erreur serveur")) {
        setMessage(
          "❌ Erreur de communication avec le serveur. Réessayez dans quelques instants."
        );
      } else {
      ...
      {!status.iosInfo?.isIOS && (
        ...
        >
          ...
          <ul style={{ margin: 0, paddingLeft: "20px" }}>
            ...
            <li>
              <strong>⚠️ Fonctionnalité en bêta - désactivée par défaut</strong>
            </li>
          </ul>
          <div
            style={{
          ...
          >
            ...
            <ol
              style={{ margin: "5px 0", paddingLeft: "20px", fontSize: "14px" }}
            >
              <li>
                Ouvrez <strong>Réglages</strong> sur votre iPhone
              </li>
              <li>
                Allez dans <strong>Safari</strong>
              </li>
              <li>
                Tapez <strong>Avancé</strong>
              </li>
              <li>
                Tapez <strong>Fonctionnalités expérimentales</strong>
              </li>
              <li>
                Activez <strong>"Notifications"</strong>
              </li>
            </ol>
          </div>
        </div>
