        ...
        <div className="install-modal" style={modalStyle}>
          <div className="install-content" style={contentStyle}>
            ...
            <div style={{ textAlign: 'left', marginBottom: '20px' }}>
                <p  style={{ color: 'black'}}><strong>1.</strong> Tapez sur le bouton "Partager" <span style={{fontSize: '20px'}}>⬆️</span> en bas de Safari</p>
                <p  style={{ color: 'black'}}><strong>2.</strong> Faites défiler et sélectionnez "Sur l'écran d'accueil"</p>
                <p  style={{ color: 'black'}}><strong>3.</strong> Tapez "Ajouter" en haut à droite</p>
              <p style={{ fontSize: '14px', color: '#666', marginTop: '10px' }}>
                💡 L'app apparaîtra sur votre écran d'accueil comme une vraie application
              </p>
            </div>
            <button onClick={() => setShowIOSInstructions(false)} style={buttonStyle}>
              Compris !
            </button>
          </div>
        </div>
      ...
      {showFirefoxInstructions && (
        <div className="install-modal" style={modalStyle}>
          <div className="install-content" style={contentStyle}>
            ...
            <div style={{ textAlign: 'left', marginBottom: '20px' }}>
              <p  style={{ color: 'black'}}><strong>1.</strong> Cliquez sur le menu ≡ (trois lignes) en haut à droite</p>
                <p  style={{ color: 'black'}}><strong>2.</strong> Sélectionnez "Installer cette application"</p>
                <p  style={{ color: 'black'}}><strong>3.</strong> Confirmez l'installation</p>
              <p style={{ fontSize: '14px', color: '#666', marginTop: '10px' }}>
                💡 L'app sera accessible depuis votre bureau ou menu applications
              </p>
            </div>
            <button onClick={() => setShowFirefoxInstructions(false)} style={buttonStyle}>
              Compris !
            </button>
          </div>
        </div>
